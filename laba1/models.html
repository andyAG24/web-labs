...
<head>
	<meta charset="utf-8">
	<link rel="stylesheet" type="text/css" href="styles/models_styles.css">
...
<body>
    ...
    <nav class="navigation">
      <a href="models.html">Модельный ряд</a>
      <a href="#">Покупателям</a>
      <a href="#">Владельцам</a>
      <a href="#">Дилеры</a>
      <a href="technology.html">Мир Субару</a>
    </nav>
    </section>
	<section class="top clearfix">
    <div class="models clearfix">
      <div class="model_1"><a href="#"><div>Legacy</div></a></div>
      <div class="model_2"><a href="#"><div>XV</div></a></div>
      <div class="model_3"><a href="#"><div>Outback</div></a></div>
      <div class="model_4"><a href="#"><div>WRX & WRX STI</div></a></div>
      <div class="model_5"><a href="#"><div>Forester</div></a></div>
    </div>
	</section>
